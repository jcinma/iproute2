...
static int red_csc573_parse_opt(struct qdisc_util *qu, int argc, char **argv, struct nlmsghdr *n)
{
...
static int red_csc573_print_opt(struct qdisc_util *qu, FILE *f, struct rtattr *opt)
{
...
static int red_csc573_print_xstats(struct qdisc_util *qu, FILE *f, struct rtattr *xstats)
{
#ifdef TC_RED_ECN
...
struct qdisc_util red_csc573_qdisc_util = {
	.id		= "red_csc573",
	.parse_qopt	= red_csc573_parse_opt,
	.print_qopt	= red_csc573_print_opt,
	.print_xstats	= red_csc573_print_xstats,
};
